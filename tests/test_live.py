...
from tests.conftest import build_market, build_oscillating_market
...
def _trending_market(n_bars=N_BARS, symbols=('SA', 'CF')):
    """This module's default universe and bar count over the shared
    oscillating builder (tests/conftest.py)."""
