...
| Page | Contents |
| --- | --- |
| [Data Pipeline](docs/data.md) | Exchange downloads, credentials, `data_update` flags, generated files, product registry |
...
| [Project Layout](docs/architecture.md) | Directory map, module boundaries, tests |
